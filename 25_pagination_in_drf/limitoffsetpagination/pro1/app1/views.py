...
from .mypaginations import MyCursorPaginationsettings, Myoffsetpaginationsettings, Mypaginationsettings
...
class StudentList(ListAPIView):
    ...
    # pagination_class = Mypaginationsettings
    # pagination_class = Myoffsetpaginationsettings
    pagination_class = MyCursorPaginationsettings
